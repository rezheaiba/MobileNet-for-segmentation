...
class TrainDataset(BaseDataset):
    def __init__(self, root_dataset, odgt, opt, batch_per_gpu=1, transforms=None, **kwargs):
    ...
    def __getitem__(self, index):
        ...
        output['img_data'] = self.transforms(batch_images)
        output['seg_label'] = self.transforms(batch_segms)
        return output
