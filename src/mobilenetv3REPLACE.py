    ...
    def __init__(
        ...
        if arch == "mobilenet_v3_large":
            ...
            inverted_residual_setting = [
                ...
                # bneck_conf(16, 3, 16, 16, True, "HS", 2, 1),  # C1
                # bneck_conf(16, 3, 72, 24, False, "HS", 2, 1),  # C2
                # bneck_conf(24, 3, 88, 24, False, "HS", 1, 1),
...
def main():
    ...
    model = MobileNetV3(dilated=True, num_classes=6, arch='mobilenet_v3_small',reduced_tail=True).cpu()
    model.eval()
    input = input.cpu()
    out = model(input)
    print(out.shape)
