...
def main(args):
    ...
    for epoch in range(start_epoch, start_epoch + epochs):
        ...
        save_file = {"model": model.state_dict(),
                     ...
                     "epoch": epoch,
                     "args": args}
        torch.save(save_file, "weights-cityscapes/model_{}.pth".format(epoch))
...
def parse_args():
    ...
    parser.add_argument("--epochs", default=100, required=False, type=int, metavar="N",
                        help="number of total epochs to train")
    parser.add_argument('--lr', default=0.0005, required=False, type=float, help='initial learning rate')
    parser.add_argument('--resume', default='./weights-cityscapes/model_220.pth', required=False,
